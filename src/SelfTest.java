public class SelfTest {
    ...
    public static boolean testMode = false;  // DONT TOUCH! defaults to false, set to true on main method run

    private final static boolean testBitBoards = true;
    private final static boolean testFENLoading = true;
    private final static boolean testEval = true;
